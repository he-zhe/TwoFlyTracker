...
result_database={'File','Male_Mean_Speed','Female_Mean_speed','Mean_body_dist','# of Collisions','events of male WE','events of female WE','male number of frames' , 'female number of frames', 'First WE 1', 'First WE 2', 'total time','total frames' };
